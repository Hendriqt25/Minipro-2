...
def buat_reservasi():
    ...
    if (nomor_kamar in kamar_lantai_2 or 
        ...
        if nomor_kamar not in reservasi:
            ...
            print(f"Reservasi untuk {nama_tamu} di kamar {nomor_kamar} pada {tanggal_reservasi} pukul {waktu_reservasi} berhasil dipesan!")
        else:
...
def admin():
    while True:
            print("\n=== Menu Admin Hotel Jatra Balikpapan ===")
...
def tamu():
        while True:
            print("\n=== Menu Tamu Hotel Jatra Balikpapan ===")
            print("1. Daftar Kamar")
